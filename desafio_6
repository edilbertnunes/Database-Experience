...
** Arquitetar sistemas distribuídos ** Criar pipelines confiáveis ** Combinar fontes de dados ** Criar a arquitetura de soluções ** Conhecimento do design do banco de dados SQL ** Colaborar com a equipe de Data Science e construir as soluções certas para essas equipes ** Conhecimentos em bancos de dados relacionais e não relacionais
